...
func (r *commentResolver) User(ctx context.Context, obj *models.Comment) (user models.User, err error) {
	if obj.UserID != 0 {
		return models.GetUserByID(obj.UserID)
	}

	return user, nil
}
func (r *mutationResolver) CreateComment(ctx context.Context, input booking.NewComment) (comment models.Comment, err error) {
	c := models.Comment{

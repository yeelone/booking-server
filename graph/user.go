...
func (r *userResolver) Groups(ctx context.Context, obj *models.User, pagination *model.Pagination) (*model.QueryGroupResponse, error) {
	skip := 0
	take := 0
	if pagination != nil {
...
func (r *userResolver) Roles(ctx context.Context, obj *models.User, pagination *model.Pagination) (*model.QueryRoleResponse, error) {
	skip := 0
	take := 0
	if pagination != nil {
		skip = pagination.Skip
...
func (r *userResolver) Tickets(ctx context.Context, obj *models.User, pagination *model.Pagination, filter *model.TicketFilterInput) (*model.QueryTicketResponse, error) {
	skip := 0
	take := 0
	if pagination != nil {
		skip = pagination.Skip
...
func (r *mutationResolver) CreateUser(ctx context.Context, input model.NewUser) (user *models.User, err error) {
...
func (r *mutationResolver) CreateUsers(ctx context.Context, input model.NewUsers) (*model.CreateUsersResponse, error) {
	resp := &model.CreateUsersResponse{}
...
func (r *mutationResolver) UpdateUser(ctx context.Context, input model.UpdateUserInput) (user *models.User, err error) {
	u := &models.User{}
...
func (r *mutationResolver) ResetPassword(ctx context.Context, input model.ResetPasword) (newPwd string, err error) {
...
func (r *mutationResolver) DeleteUser(ctx context.Context, input model.DeleteIDInput) (result bool, err error) {
	if len(input.Ids) > 0 {

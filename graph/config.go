...
func (r *queryResolver) Config(ctx context.Context) (resp *model.ClientConfig, err error) {
...
func (r *mutationResolver) Config(ctx context.Context, input model.ConfigInput) (resp *model.ClientConfig, err error) {

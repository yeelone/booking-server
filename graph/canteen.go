...
func (r *canteenResolver) Count(ctx context.Context, obj *models.Canteen) ([]model.CanteenCount, error) {
	counts := make([]model.CanteenCount, 0)
	result, err := models.CountBookingByCanteen(obj.ID)

	for date, data := range result {
		count := model.CanteenCount{}
		count.Date = date
...
func (r *mutationResolver) CreateCanteens(ctx context.Context, input model.NewCanteen) (canteen *models.Canteen, err error) {
	c := &models.Canteen{
		Name:                     input.Name,
...
func (r *mutationResolver) UpdateCanteens(ctx context.Context, input model.UpdateCanteenInput) (*models.Canteen, error) {
	c := &models.Canteen{}
...
func (r *mutationResolver) DeleteCanteens(ctx context.Context, input model.DeleteIDInput) (bool, error) {
	if len(input.Ids) > 0 {
...
func (r *mutationResolver) CreateQrcode(ctx context.Context, input model.CanteenQrcodeInput) (string, error) {

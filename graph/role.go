...
func (r *roleResolver) Users(ctx context.Context, obj *models.Role, filter *model.UserFilterInput, pagination *model.Pagination) (*model.QueryUserResponse, error) {
	if pagination == nil {
...
func (r *mutationResolver) CreateRole(ctx context.Context, input model.NewRole) (*models.Role, error) {
	m := &models.Role{
		Name: input.Name,
	}
...
func (r *mutationResolver) UpdateRole(ctx context.Context, input model.UpdateRoleInput) (*models.Role, error) {
	m := &models.Role{}
...
func (r *mutationResolver) DeleteRole(ctx context.Context, input model.DeleteIDInput) (bool, error) {
	if len(input.Ids) > 0 {
...
func (r *mutationResolver) CreateUserAndRoleRelationship(ctx context.Context, input model.UserAndRoleRelationshipInput) (bool, error) {
	uids := []uint64{}
...
func (r *mutationResolver) RemoveUserAndRoleRelationship(ctx context.Context, input model.UserAndRoleRelationshipInput) (bool, error) {
	uids := []uint64{}
	if input.UserIds != nil {
		for _, id := range input.UserIds {
			uids = append(uids, uint64(id))

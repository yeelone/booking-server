...
func (r *mutationResolver) CreateDishes(ctx context.Context, input model.NewDishes) (*models.Dishes, error) {
	m := &models.Dishes{
		Name:    input.Name,
...
func (r *mutationResolver) UpdateDishes(ctx context.Context, input model.UpdateDishesInput) (*models.Dishes, error) {
	g := &models.Dishes{}
...
func (r *mutationResolver) DeleteDishes(ctx context.Context, input model.DeleteIDInput) (bool, error) {
	if len(input.Ids) > 0 {
